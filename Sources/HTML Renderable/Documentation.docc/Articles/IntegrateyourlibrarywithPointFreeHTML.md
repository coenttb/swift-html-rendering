...
Think of it like adding a printer to your computer. Your documents don't change - you just gain the ability to print them. Same idea here: your HTML and CSS types stay the same, but now they can render through HTML_Renderable.
...
These types are **your types**. They don't depend on HTML_Renderable. They can live in their own package, have their own tests, and be used anywhere.

### Step 2: the magic of extensions

Now let's make these types work with HTML_Renderable. We don't modify your types - we just extend them:
...
Your element becomes a function that produces HTML_Renderable. Clean and intuitive.
...
Your HTML and CSS types don't need to import HTML_Renderable. They stay clean and independent:
...
Want to know more about testing? Check out our [testing guide](TestingHTML_Renderable.md).
